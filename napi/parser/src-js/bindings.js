  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-android-arm64/package.json").version;
        if (
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-android-arm-eabi/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-win32-x64-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-win32-ia32-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-win32-arm64-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    try {
      ...
      const bindingPackageVersion =
        require("@oxc-parser/binding-darwin-universal/package.json").version;
      if (
        bindingPackageVersion !== "0.93.0" &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-darwin-x64/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-darwin-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-freebsd-x64/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-freebsd-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-x64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-arm64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-arm64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-arm-musleabihf/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-arm-gnueabihf/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-loong64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-loong64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-riscv64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxc-parser/binding-linux-riscv64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.93.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-linux-ppc64-gnu/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-linux-s390x-gnu/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-openharmony-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-openharmony-x64/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxc-parser/binding-openharmony-arm/package.json").version;
        if (
          bindingPackageVersion !== "0.93.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
