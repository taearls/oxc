  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/android-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ) {
          throw new Error(
            `Native binding package version mismatch, expected 1.19.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
          );
        }
        return binding;
      } catch (e) {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/android-arm-eabi/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/win32-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/win32-ia32/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/win32-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    try {
      ...
      const bindingPackageVersion =
        require("@oxlint/darwin-universal/package.json").version;
      if (
        bindingPackageVersion !== "1.19.0" &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/darwin-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/darwin-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/freebsd-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/freebsd-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-x64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-arm64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-arm64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-arm-musleabihf/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-arm-gnueabihf/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-loong64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-loong64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-riscv64-musl/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxlint/linux-riscv64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "1.19.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/linux-ppc64-gnu/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/linux-s390x-gnu/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/openharmony-arm64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/openharmony-x64/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxlint/openharmony-arm/package.json").version;
        if (
          bindingPackageVersion !== "1.19.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
