...
/// Check if a function's formal parameters are within a test call expression argument context.
/// This replaces the logic that previously relied on AstKind::Argument traversal.
pub fn is_function_in_test_call_context(formal_params: &AstNode<FormalParameters<'_>>) -> bool {
    use crate::generated::ast_nodes::AstNodes;
