# Prettier Conformance Test Results - Main Branch
...
| js/call/boolean/boolean.js                                       |  97.12%   |             call             |
...
| js/identifier/parentheses/let.js                                 |  82.27%   |          identifier          |
...
| typescript/chain-expression/call-expression.ts                              |  68.75%   |      chain-expression      |
| typescript/chain-expression/member-expression.ts                            |  65.67%   |      chain-expression      |
| typescript/chain-expression/test.ts                                         |   0.00%   |      chain-expression      |
...
| typescript/class-comment/class-implements.ts                                |  98.89%   |       class-comment        |
...
| typescript/non-null/optional-chain.ts                                       |  72.22%   |          non-null          |
...
- **chain-expression**: 3 tests, very low pass rates (0.00% - 68.75%)
