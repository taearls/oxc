...
class Cl {
  ...
  publicGetPrivateField() {
    return _get_privateFieldValue.call(
  ...
  testUpdates() {
    ...
    babelHelpers.toSetter(
      ...
      (_set_privateFieldValue.call(
        babelHelpers.assertClassBrand(_Cl_brand, this),
        ((_this$privateFieldVal = _get_privateFieldValue.call(
          babelHelpers.assertClassBrand(
            _Cl_brand,
            this,
          ),
        )),
        (_this$privateFieldVal2 = _this$privateFieldVal++),
        _this$privateFieldVal),
      ),
      _this$privateFieldVal2);
    this.publicFieldValue = this.publicFieldValue++;
    _set_privateFieldValue.call(
      babelHelpers.assertClassBrand(_Cl_brand, this),
      ((_this$privateFieldVal3 = _get_privateFieldValue.call(
        babelHelpers.assertClassBrand(
          _Cl_brand,
          this,
        ),
      )),
      ++_this$privateFieldVal3),
    );
    ++this.publicFieldValue;
    _set_privateFieldValue.call(
      babelHelpers.assertClassBrand(_Cl_brand, this),
      _get_privateFieldValue.call(
        babelHelpers.assertClassBrand(
          _Cl_brand,
          this,
        ),
