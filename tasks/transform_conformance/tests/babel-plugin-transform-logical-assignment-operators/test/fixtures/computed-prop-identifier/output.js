...
(_unboundObj2 = unboundObj)[_unboundProp2 = unboundProp] &&
  (_unboundObj2[_unboundProp2] = 5);
(_unboundObj3 = unboundObj)[_mutatedProp2 = mutatedProp] &&
  (_unboundObj3[_mutatedProp2] = 6);

(_mutatedObj = mutatedObj)[boundProp] && (_mutatedObj[boundProp] = 7);
(_mutatedObj2 = mutatedObj)[_unboundProp3 = unboundProp] &&
  (_mutatedObj2[_unboundProp3] = 8);
(_mutatedObj3 = mutatedObj)[_mutatedProp3 = mutatedProp] &&
  (_mutatedObj3[_mutatedProp3] = 9);

(_boundObj$prop = boundObj.prop)[boundProp] && (_boundObj$prop[boundProp] = 10);
(_boundObj$prop2 = boundObj.prop)[_unboundProp4 = unboundProp] &&
  (_boundObj$prop2[_unboundProp4] = 11);
(_boundObj$prop3 = boundObj.prop)[_mutatedProp4 = mutatedProp] &&
  (_boundObj$prop3[_mutatedProp4] = 12);
