...
const ObjectInterpolation = (p) => {
  ...
  return <_StyledP10 $_css4={theme.colors.red}>H</_StyledP10>;
};
...
const ObjectInterpolationMember = (p) => {
  const theme = useTheme();
  const color = "red";
  return <_StyledP13 $_css17={theme.colors[color]}>H</_StyledP13>;
};
const RenderPropComponentCSSProp = () => {
  return <RenderPropComponent>{() => <_StyledDiv2 />}</RenderPropComponent>;
};
