import styled, {
  ...
  default as _styled0,
  default as _styled1,
  default as _styled10,
  default as _styled11,
  default as _styled12,
  default as _styled13,
  default as _styled14,
  default as _styled15,
  default as _styled16,
  default as _styled17,
  default as _styled18,
  default as _styled19,
  default as _styled20,
  default as _styled21,
  default as _styled22,
  default as _styled23,
  default as _styled24,
  default as _styled25,
  default as _styled26,
...
const LocalCssHelperProp = (p) => <_StyledP0 $_css3={p.color}>A</_StyledP0>;
const DynamicCssHelperProp = (p) => <_StyledP1>A</_StyledP1>;
...
const ObjectInterpolation = (p) => {
  ...
  return <_StyledP12 $_css13={theme.colors.red}>H</_StyledP12>;
};
const ObjectInterpolationCustomComponent = (p) => {
  const theme = useTheme();
  return <_StyledThing3 $_css14={theme.colors.red}>H</_StyledThing3>;
};
const ObjectInterpolationInKey = (p) => {
  const theme = useTheme();
  return <_StyledThing4 $_css15={theme.breakpoints.md}>H</_StyledThing4>;
};
const ObjectFnInterpolationInKey = (p) => {
  const theme = useTheme();
  return <_StyledThing5 $_css16={theme.breakpoints.md()}>H</_StyledThing5>;
};
const ObjectFnSimpleInterpolationInKey = (p) => {
  const foo = "@media screen and (max-width: 600px)";
  return <_StyledThing6 $_css17={foo}>H</_StyledThing6>;
};
