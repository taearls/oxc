...
function _handleAsyncIterables() {
  _handleAsyncIterables = babelHelpers.wrapAsyncGenerator(
    function* (asyncIterable) {
      if (true) {
        ...
        try {
          for (
            var _iterator = babelHelpers.asyncIterator(asyncIterable), _step;
            (_iteratorAbruptCompletion = !(_step =
              yield babelHelpers.awaitAsyncGenerator(_iterator.next())).done);
