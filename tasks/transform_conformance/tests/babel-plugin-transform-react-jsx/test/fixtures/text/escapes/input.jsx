...
<div>&ordf; &laquo; &not; &shy; &reg; &macr; &deg; &plusmn; &sup2; &sup3;</div>;
<div>
...
<div>
  &uacute; &ucirc; &uuml; &yacute; &thorn; &yuml; &fnof; &Alpha; &Beta; &Gamma;
</div>;
<div>
  &Delta; &Epsilon; &Zeta; &Eta; &Theta; &Iota; &Kappa; &Lambda; &Mu; &Nu;
</div>;
<div>&Xi; &Omicron; &Pi; &Rho; &Sigma; &Tau; &Upsilon; &Phi; &Chi; &Psi;</div>;
<div>
...
<div>
  &hellip; &prime; &Prime; &oline; &frasl; &weierp; &image; &real; &trade;
  &alefsym;
</div>;
<div>
...
<div>&sum; &minus; &lowast; &radic; &prop; &infin; &ang; &and; &or; &cap;</div>;
<div>&cup; &int; &there4; &sim; &cong; &asymp; &ne; &equiv; &le; &ge;</div>;
<div>
