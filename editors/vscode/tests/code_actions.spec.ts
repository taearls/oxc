...
teardown(async () => {
  ...
  await workspace
    ...
    .update("codeActionsOnSave", undefined);
...
suite("code actions", () => {
  ...
  testSingleFolderMode("listed code actions", async () => {
    ...
    const codeActions: ProviderResult<Array<CodeAction>> =
  ...
  test('changing configuration flag "fix_kind" will reveal more code actions', async () => {
    ...
    const codeActionsNoFix: ProviderResult<Array<CodeAction>> =
      await commands.executeCommand(
        "vscode.executeCodeActionProvider",
        fileUri,
        {
    ...
    const codeActionsWithFix: ProviderResult<Array<CodeAction>> =
      await commands.executeCommand(
        "vscode.executeCodeActionProvider",
        fileUri,
        {
  ...
  test('changing configuration "unusedDisableDirectives" will reveal more code actions', async () => {
    ...
    await workspace
      ...
      .update("unusedDisableDirectives", "warn");
    await workspace.saveAll();
