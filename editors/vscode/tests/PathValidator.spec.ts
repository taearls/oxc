...
suite("validateSafeBinaryPath", () => {
  test("should return true for valid binary paths", () => {
    strictEqual(
      validateSafeBinaryPath("/usr/local/bin/oxc_language_server"),
      true,
    );
    strictEqual(
      validateSafeBinaryPath("C:\\Program Files\\oxc_language_server.exe"),
      true,
    );
  ...
  test("should reject paths with malicious characters", () => {
    ...
    strictEqual(
      validateSafeBinaryPath("oxc_language_server|cat /etc/passwd"),
      false,
    );
    strictEqual(validateSafeBinaryPath("oxc_language_server$PATH"), false);
    strictEqual(
      validateSafeBinaryPath("oxc_language_server>output.txt"),
      false,
    );
    ...
    strictEqual(
      validateSafeBinaryPath("oxc_language_server & del /f *"),
      false,
    );
  });
  ...
  test("should reject paths not containing oxc_language_server", () => {
    ...
    strictEqual(
      validateSafeBinaryPath("/oxc_language_server/malicious"),
      false,
    );
    strictEqual(
      validateSafeBinaryPath("C:\\oxc_language_server\\evil.exe"),
      false,
    );
  });
});
